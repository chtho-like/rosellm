...
# This config is expected to be updated after running
# `python bench_flashattn.py --find-best-config ...` on the current GPU.
...
def flash_attn(
    ...
    *,
    ...
    config: KernelConfig = BEST_CONFIG,
) -> torch.Tensor:
