...
class OPTLearnedPositionalEmbedding(nn.Embedding):
    def __init__(self, num_embeddings: int, embedding_dim: int):
        # Why offset by 2?
        # Position 0: reserved for padding.
        # Position 1: reserved for special tokens such as BOS, EOS, etc.
        # This design is inherited from fairseq.
        self.offset = 2
...
class OPTForCausalLM(OPTPreTrainedModel):
    ...
    def __init__(self, config: OPTConfig):
        ...
        # The lm_head weight is automatically tied to the embed_tokens weight.
