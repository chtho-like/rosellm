...
| Build a small reproduction | [Source-level lab](../source-lab.md) | [derivations and code](../derivations-and-code.md), then one case chapter | A pinned, tested mechanism reproduction whose claims stay inside its evidence boundary |
